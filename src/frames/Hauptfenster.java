...
public class Hauptfenster extends JFrame implements IFensterEigenschaften, IFarben, ISchriften
{
	...
	private void initialize()
	{
		...
		setiFrameGroesseX(cpHauptfenser.getWidth());
		setiFrameGroesseY(cpHauptfenser.getHeight());
	...
	public static void setiFrameGroesseX(int iFrameGroesseX)
	{
		Hauptfenster.iFrameGroesseX = iFrameGroesseX;
	}

	public static int getiFrameGroesseY()
	{
		return iFrameGroesseY;
	}
